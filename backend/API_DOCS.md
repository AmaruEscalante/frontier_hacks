...
**🎯 Automatic Template Setup:** Every new session automatically clones [AndresNinou/template](https://github.com/AndresNinou/template) to `/home/user/template` and runs `pnpm install`. Claude starts with this template ready to use!
